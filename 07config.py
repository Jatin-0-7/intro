...
██████╔╝███████╗░░╚██╔╝░░░░░░
╚═════╝░╚══════╝░░░╚═╝░░░░░░
𝐃𝐞𝐧𝐯𝐞𝐫 𝐈𝐏𝐓𝐕 𝘽𝙡𝙪𝙚𝙓 𝙑𝟓 𝘾𝙤𝙣𝙛𝙞𝙜 𝙋𝙔
\33[0m\33[0;1;5;m""")
print(feyzo) 
...
╔════❱❱❱ 𝐃𝐞𝐯𝐢𝐜𝐞 👑 𝐈𝐧𝐟𝐨𝐫𝐦𝐚𝐭𝐢𝐨𝐧❱❱❱ ══❱❱❱
╠𝙓🎃 𝐅𝐮𝐥𝐥𝐍𝐚𝐦𝐞 ❱❱❱ """+fname+"""
╠𝙓🤖 𝐁𝐢𝐥𝐥𝐢𝐧𝐠-𝐃𝐚𝐭𝐞 ❱❱❱ """+str(bill)+"""
╠𝙓🥲 𝐑𝐞𝐜𝐡𝐚𝐫𝐠𝐞-𝐃𝐚𝐭𝐞 ❱❱❱ """+expire_billing_date+"""
╠𝙓👩 𝐔𝐬𝐞𝐫𝐧𝐚𝐦𝐞 ❱❱❱ """+login+"""
╠𝙓🔑 𝐏𝐚𝐬𝐬𝐰𝐨𝐫𝐝 ❱❱❱ """+password+"""
╠𝙓🌝 𝐀𝐝𝐮𝐥𝐭-𝐏𝐚𝐬𝐬 ❱❱❱ """+parent_password+"""
╠𝙓🚨 𝐥𝐬 ❱❱❱ """+ls+"""
╠𝙓🚦 𝐓𝐚𝐫𝐢𝐟𝐟-𝐈𝐃 ❱❱❱ """+tariff_plan_id+"""
╠𝙓🚦 𝐓𝐚𝐫𝐢𝐟𝐟-𝐏𝐥𝐚𝐧 ❱❱❱ """+tariff_plan+"""
╠𝙓👪 𝐌𝐚𝐱-𝐎𝐧𝐥𝐢𝐧𝐞 ❱❱❱ """+max_online+"""
╠𝙓📻 𝐒𝐓𝐁-𝐓𝐲𝐩𝐞 ❱❱❱ """+stb_type+"""
╠𝙓🌍 𝐂𝐨𝐮𝐧𝐭𝐫𝐲 ❱❱❱ """+country+"""
╠𝙓⚙️ 𝐒𝐞𝐭𝐭𝐢𝐧𝐠𝐬-𝐏𝐚𝐬𝐬 ❱❱❱ """+settings_password+"""
╚═══⦿⚠️ 𝐌𝐞𝐬𝐬𝐚𝐠𝐞 ❱❱❱ """+comment+""" """
		imza="""
		
╔════❱❱❱😈𝟎𝟕𝐱𝐂𝐨𝐧𝐟𝐢𝐠😈
╠🖤 𝐒𝐜𝐚𝐧 𝐁𝐘 ❱❱❱ """+str(nickn)+"""
╠🖤 𝐃𝐚𝐭𝐞-𝐎𝐟-𝐒𝐜𝐚𝐧 ❱❱❱ """+str(time.strftime('%d-%m-%Y'))+"""
╠🖤 𝐑𝐞𝐚𝐥 ❱❱❱ """+str(reall)+"""
╠🖤 𝐏𝐨𝐫𝐭𝐚𝐥 ❱❱❱ http://"""+str(panell)+"""/c/
╠🖤 𝐌𝐚𝐜-𝐓𝐲𝐩𝐞 ❱❱❱ """+str(uzmanm)+"""
╠🖤 𝐌𝐚𝐜 ❱❱❱ """+str(mac)+"""
╠🖤 𝐄𝐱𝐩𝐢𝐫𝐞 ❱❱❱ """+str(trh)+"""
╠🖤 𝐕𝐏𝐍-𝐂𝐨𝐮𝐧𝐭𝐫𝐲 ❱❱❱ """+str(durum)+"""
╠🖤 𝐕𝐏𝐍 ❱❱❱ """+str(vpn)+""" """+str(playerapi)+""" 
╠👑 🇮🇳 𝐓𝐞𝐥𝐞𝐠𝐫𝐚𝐦 ❱❱❱ https://t.me/IPTV07INDIA
╚══❱❱❱❱ ☠️ 𝟎𝟕𝐱 𝐈𝐏𝐓𝐕 𝐒𝐜𝐚𝐧𝐧𝐞𝐫 ☠️
...
╔══⦿💫07 𝑪𝒐𝒎𝒎𝒖𝒏𝒊𝒕𝒚 ✰
╠✰ 🍑 𝑰𝒎𝒂𝒈𝒆:⫸ """+m3uimage+"""
╠ ✰⚧️𝑴3𝒖 𝑳𝒊𝒏𝒌:⫸ """+type_tiny.tinyurl.short(m3ulink)+""" 
╚═════ @IPTV07INDIA™✰
...
def device(mac):
	...
	SINGENC=SING.upper()
	sifre="""
╔══🏴‍☠️𝐒𝐭𝐚𝐥𝐤𝐞𝐫 𝐏𝐨𝐫𝐭𝐚𝐥 𝐃𝐞𝐭𝐚𝐢𝐥𝐬🏴‍☠️
╠✰ 🗝️ 𝐒𝐋-𝐍𝐮𝐦 ❱❱❱ """+SN+"""   
╠✰ 🗝️ 𝐒𝐋_𝐂𝐮𝐭 ❱❱❱ """+SNCUT+"""
╠✰ 🆔 𝐃𝐞𝐯𝐢𝐜𝐞 𝐈'𝐝 ❶ ❱❱❱ """+DEVENC+"""
╠✰ 🆔 𝐃𝐞𝐯𝐢𝐜𝐞 𝐈'𝐝 ❷ ❱❱❱ """+SINGENC+"""
╠✰ 📝 𝐒𝐢𝐠𝐧𝐚𝐭𝐮𝐫𝐞 ❱❱❱ """+DEVENC1+"""
╚════⦿ 😈 𝐒𝐜𝐚𝐧 𝐁𝐘 ❱❱❱ """+str(nickn)+""" """	return sifre
